...
# MAGIC #### bear in mind that Spark data frame is the most efficient when it comes to distribution, Panda df is not distibuted and therefore is not scallabale across nodes
...
spdf_sales =          (spark.read.format("csv")
                                 .option("header", "true")
